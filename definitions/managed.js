...
ctx =>`
    ...
    FROM 
        ${ctx.ref('HC_ext_clientes2')} cl
    JOIN 
        ${ctx.ref('HC_ext_enderecos2')} ad
        ON cl.cliente_cpf = ad.cliente_cpf
    JOIN 
        ${ctx.ref('HC_ext_itens_produtos_pedidos2')} it
        ON cl.cliente_cpf = it.pedido_cliente_cpf
    `)


transformation.transform(
    'HC_tb_itens_pedidos_clientes2', 
    'managed', 
    'table', 
    ['managed'], 
    ['HC_ext_clientes2', 'HC_ext_enderecos2', 
